...
Для работы этого модуля вам необходимо создать в VK своё приложение.
...
- окно логина можно закрывать. В нём также будет отображаться успешное подключение.
